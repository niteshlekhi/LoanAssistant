...
public class Maps2Activity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String address = "";
        if (getIntent().hasExtra("keyAddress"))
            address = getIntent().getStringExtra("keyAddress");
...
//            getDirection = findViewById(R.id.btnGetDirection);
            new FetchURL(Maps2Activity.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
